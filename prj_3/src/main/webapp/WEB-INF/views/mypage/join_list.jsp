		...
		<form action="waitList.do" id="frm2">
			...
			<table class="table table-hover" style="width: 1000px">
				...
				<c:forEach var="list" items="${ list }">
					<tr>
						<td><c:out value="${ list.clubName }"></c:out></td>
						<td>${ list.host }</td>
						<td>${ list.clubDate }</td>
						<td><form action="joinList.do" id="frm3">
						<input type="button" value="취소하기" id="cancel" onclick="javascript:location.href='removeJoin.do?userId=${lsDomain.userId }&clubNum=${list.clubNum }'"></form> </td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
