...
#colorBtn{position: absolute; left: 720px; top: 15px; width:180px;height: 50px;font-size:20px;
		border: 1px solid #333;cursor: pointer;background-color: #F7A144;color:#FFF;font-weight: bold;border-radius: 10px;}
#whiteBtn{position: absolute; left: 900px; top: 15px; width:180px;border-radius: 10px;font-size:20px;
		height: 50px;border: 1px solid #333;cursor: pointer;background-color: #fff;color:#333;font-weight: bold}
#div1{position: absolute;width:500px;height:30px;left:660px;top: 130px;border-bottom: 3px solid #5E5E5E}
#div2{position: absolute;width:500px;height:30px;left:660px;top: 200px;}
#div3{position: absolute;width:500px;height:30px;left:660px;top: 280px;}
...
#nextBtn{width:500px;height: 50px;background-color: #333333; color: #FFF;font-size: 18px;font-weight:bold;
		border-radius: 10px;position: absolute; left:660px; top:370px;cursor: pointer;}
...
<form id="frm" name="frm" action="user_dup_process.do" method="post">
<div id="container">
	<div id="div1">
		<font id="font3">사용자 중복 확인</font>
	</div>
	<div id="div2">
