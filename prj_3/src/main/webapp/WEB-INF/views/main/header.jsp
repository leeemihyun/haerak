...
LoginSessionDomain lsDomain = (LoginSessionDomain)session.getAttribute("loginData");
%>
...
<div class="navi_club">
   <a href="http://localhost/prj_3/category.do" style="color: inherit;"><font size="4px"><strong>클럽</strong></font></a><br><br>
</div><!-- navi_club -->


<div class="navi_challenge">
   <a href="http://localhost/prj_3/category.do" style="color: inherit;"><font size="4px"><strong>챌린지</strong></font></a><br><br>
</div><!-- navi_challenge -->


<div class="navi_login">
  <a href="http://localhost/prj_3/login.do" style="color: inherit;"><font size="4px"><strong>로그인</strong></font></a><br><br>
</div><!-- navi_login  -->
